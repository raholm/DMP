...
I am interested in three approaches to solving the reinforcement learning problem which are \textit{Dynamic Programming}, \textit{Monte Carlo}, and \textit{Temporal-Learning Difference}. These families of algorithms are all model-free, i.e. the agent does not have an internal model of the environment. Possible algorithms that have caught my interest are:
