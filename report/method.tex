...
\begin{document}
    ...
    In order to do this experiments we also need to choose state representations and we choose to use two different. The board state with all additional information and the directional distance state with all additional information, as described below, since they contains the most amount of information.
