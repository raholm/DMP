...
\begin{document}
    ...
    To perform this experiments we also require a reward function which was decided based on the reward experiments by picking the best performing one in early testing. It turned out to be the reward function that gave 0 reward each time step and positive score as reward at the end of the episode.
